                            ...
                            <div className="card-body">
                                ...
                                <form className="row g-3 needs-validation" noValidate>
                                    ...
                                    <div className="col-md-2">
                                        <label htmlFor="maHangSanXuat" className="form-label">Mã Hãng sản xuất</label>
                                        <input type="text" className="form-control form-control-sm" id="maHangSanXuat"
                                               required />
                                    ...
                                    {/* <!--Tên Sản Phẩm--> */}
                                    <div className="col-md-2">
                                        <label htmlFor="tenHangSanXuat" className="form-label">Tên Hãng sản xuất</label>
                                        <input type="text" className="form-control form-control-sm" id="tenHangSanXuat"
                                               required />
                                    ...
                                    <div>
                                        <button className="col-md-2 btn btn-primary mb-3" type="button" id="nutTimKiem">
                                    ...
                                    <Modal show={showModal} onHide={toggleModal}>
                                        ...
                                        <Modal.Body>
                                            <form>
                                                Mã Hãng Sản Xuất: <input type="text" id="maHangSanXuat" className="form-control" /><br />
                                                Tên Hãng Sản Xuất: <input type="text" id="tenHangSanXuat" className="form-control" /><br />
