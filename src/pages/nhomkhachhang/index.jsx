                  ...
                  <div className="card-body">
                    ...
                    <form className="row g-3 needs-validation" noValidate>
                      ...
                      <div className="col-md-2">
                        ...
                        <input type="text" className="form-control form-control-sm" id="maNhom" required />
                      </div>
                      {/*Kết Mã Nhóm Khách hàng*/}
                      {/*Tên Nhóm Khách hàng*/}
                      <div className="col-md-2">
                        <label htmlFor="tenNhom" className="form-label">Tên Nhóm</label>
                        <input type="text" className="form-control form-control-sm" id="tenNhom" required />
                      </div>
                    ...
                    <Modal show={showModal} onHide={toggleModal}>
                      ...
                      <Modal.Body>
                        <form>
                          ...
                          <input type="text" id="tenNhom" className="form-control" />
                          <br />
                          <label htmlFor="soTien">Số tiền</label>
                          <input type="number" id="soTien" className="form-control" />
                          <br />
                          <label htmlFor="chietKhau">Chiết khấu</label>
                          <input type="number" id="chietKhau" className="form-control" />
                          <br />
                    ...
                    {/*Nút Thêm Mới*/}
                    <div>
                      <Button variant="success" onClick={toggleModal}>Thêm Mới</Button>
                    </div>
                        ...
                        <div className="table-responsive col-md-2 card-body">
                          <table id="example-database" className="table table-striped table-bordered dt-responsive nowrap table table-editable table-nowrap align-middle table-edits" style={{borderCollapse: 'collapse', borderSpacing: 0, width: '100%'}}>
                            ...
                            <tbody>
                              ...
                              <tr>
                                  <td><input type="checkbox" className="checkItem" /></td>
                                  <td></td>
                                  <td></td>
                                  <td></td>
                                  <td></td>
