        ...
        <div className="page-content">
          <div className="container-fluid">
            <div className="col-md-8">
              <h6 className="page-title">Danh Sản Phẩm</h6>
            </div>
            <div className="card">
              <div className="card-body">
                ...
                <form className="row g-3 needs-validation" noValidate>
                  ...
                  <div className="col-md-2">
                    <label htmlFor="validationCustom03" className="form-label">Mã Loại Sản Phẩm</label>
                    <input type="text" className="form-control form-control-sm" id="validationCustom03" required />
                  </div>
                  {/* <!--Kết Thúc Mã Sản Phẩm--> */}
                  {/* <!--Tên Sản Phẩm--> */}
                  <div className="col-md-2">
                    <label htmlFor="validationCustom04" className="form-label">Tên Loại Sản Phẩm</label>
                    <input type="text" className="form-control form-control-sm" id="validationCustom04" required />
                  </div>
                ...
                <form className="row g-3 needs-validation" noValidate>
                  {/* <!--Mã Sản Phẩm--> */}
                  <div className="col-md-2">
                    <label htmlFor="validationCustom05" className="form-label">Mã Phân Loại Sản Phẩm</label>
                    <input type="text" className="form-control form-control-sm" id="validationCustom05" required />
                  </div>
                  {/* <!--Kết Thúc Mã Sản Phẩm--> */}
                  {/* <!--Tên Sản Phẩm--> */}
                  <div className="col-md-2">
                    <label htmlFor="validationCustom06" className="form-label">Tên Phân Loại Sản Phẩm</label>
                    <input type="text" className="form-control form-control-sm" id="validationCustom06" required />
                  </div>
                  {/* <!--Kết Thúc Tên Sản Phẩm--> */}
                </form> {/* Added closing tag */}
                {/* <!-- Fomt điền điều kiện lọc --> */}
                <form className="row g-3 needs-validation" noValidate>
                  {/* <!--Mã Sản Phẩm--> */}
                  <div className="col-md-2">
                    <label htmlFor="validationCustom07" className="form-label">Mã Sản Phẩm</label>
                    <input type="text" className="form-control form-control-sm" id="validationCustom07" required />
                  </div>
                  {/* <!--Kết Thúc Mã Sản Phẩm--> */}
                  {/* <!--Tên Sản Phẩm--> */}
                  <div className="col-md-2">
                    <label htmlFor="validationCustom08" className="form-label">Tên Loại Sản Phẩm</label>
                    <input type="text" className="form-control form-control-sm" id="validationCustom08" required />
                  </div>
                  {/* <!--Kết Thúc Tên Sản Phẩm--> */}
                  <div>
                  ...
                  <Modal show={showModal} onHide={toggleModal}>
                    ...
                    <Modal.Body>
                      <form>Mã Sản Phẩm:
                        <input type="text" id="maSanPham" className="form-control" />
                        <br />Tên Sản Phẩm:
                        <input type="text" id="tenSanPham1" className="form-control" />
                        <br />Tên Mã Vạch:
                        <input type="text" id="tenSanPham2" className="form-control" />
                        <br />Hệ Số 1:
                        <input type="text" id="tenSanPham3" className="form-control" />
                        <br />Hệ Số 2:
                        <input type="text" id="tenSanPham4" className="form-control" />
                        <br />Hệ Số 3:
                        <input type="text" id="tenSanPham5" className="form-control" />
                        <br />Hệ Số 4:
                        <input type="text" id="tenSanPham6" className="form-control" />
                        <br />
                        ...
                        <textarea className="form-control" id="elm1" name="area">
                        </textarea>
                        <br />
                  ...
                  <Modal show={showModal} onHide={toggleModal}>
                    ...
                    <Modal.Body className="d-flex flex-column align-items-center">
                      ...
                      <div id="productInfo" className="text-center mb-3"></div>
                      {/* <!-- Logo goes here --> */}
                      <div id="logo" className="mb-3">
                        <img src="/Src/MeXiu.WebsiteAdmin/MeXiu.WebsiteAdmin/assets/images/favicon.ico" alt="Logo" style={{width:"50px", height:"50px"}} />
                      </div>
                      {/* <!-- Input for quantity --> */}
                      <div className="mb-3 w-50">
                        <label htmlFor="quantity" className="form-label">Số lượng cần in</label>
                        <input type="number" className="form-control" id="quantity" />
                      </div>
                    </Modal.Body>
                    <Modal.Footer className="justify-content-center">
                      <Button variant="secondary" onClick={toggleModal}>Đóng</Button>
                  ...
                  <Modal show={showModal} onHide={toggleModal}>
                    ...
                    <Modal.Body>
                      <div className="d-flex flex-column align-items-center">
                        ...
                        {/* <!-- Input for quantity --> */}
                        <div className="mb-3">
                          <label htmlFor="quantity2" className="form-label">Số lượng cần in</label>
                          <input type="number" className="form-control" id="quantity2" />
                        </div>
                      </div>
                    </Modal.Body>
                    <Modal.Footer className="justify-content-center">
                  ...
                  <div>
                    <button type="button" className="btn btn-success mr-2" onClick={toggleModal}>
                      <i className="fas fa-plus-circle"></i> Thêm Mới
                    </button>
                    <button type="button" className="btn btn-success" id="exportQrCode">
                ...
                <div className="btn-group mt-3" role="group" aria-label="Basic example">
                    <button type="button" className="btn btn-secondary" onClick={() => openPage('BanSanPham')}> Bảng Số Lượng Sản Phẩm </button>
                    <button type="button" className="btn btn-secondary" onClick={() => openPage('BanSanPhamChiTiet')}>Bảng Sản Phẩm Chi Tiết</button>
                ...
                <div className="card-body">
                  ...
                  <div className="card-body">
                    <div className="row">
                        <div id="BanSanPhamChiTiet" className="tabcontent" style={{display: "none"}}>
                      
                      <div className="table-responsive">
                        <table id="example-database-datatable-buttons2"
                        className="table table-striped table-bordered dt-responsive nowrap table table-editable table-nowrap align-middle table-edits"
                        style={{borderCollapse: "collapse", borderSpacing: "0", width: "100%"}}>
                          <thead>
                            <tr>
