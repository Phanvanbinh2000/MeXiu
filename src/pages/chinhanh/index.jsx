                            ...
                            <div className="card-body">
                                ...
                                <form className="row g-3 needs-validation" noValidate>
                                    ...
                                    <div className="col-md-2">
                                        <label htmlFor="maChiNhanh" className="form-label">Mã Chi Nhánh</label>
                                        <input type="text" className="form-control form-control-sm" id="maChiNhanh"
                                               required />
                                    ...
                                    {/* <!--Tên Sản Phẩm--> */}
                                    <div className="col-md-2">
                                        <label htmlFor="tenChiNhanh" className="form-label">Tên Chi Nhánh</label>
                                        <input type="text" className="form-control form-control-sm" id="tenChiNhanh"
                                               required />
                                    ...
                                    <div>
                                        <button className="col-md-2 btn btn-primary mb-3" type="button" id="buttonTimKiem">
                                    ...
                                    <Modal show={showModal} onHide={toggleModal}>
                                        ...
                                        <Modal.Body>
                                        <form>
                                                        Mã Chi Nhánh: <input type="text" id="maChiNhanh" className="form-control" /><br />
                                                        Tên Chi Nhánh: <input type="text" id="tenChiNhanh" className="form-control" /><br />
