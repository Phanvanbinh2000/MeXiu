            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-2">
                  ...
                  <input type="text" className="form-control" placeholder="Nhập Mã Khách Hàng" id="maNhaCungCap" />
                </div>
                <div className="col-md-2">
                  <label>Tên Nhà Cung Cấp</label>
                  <input type="text" className="form-control" placeholder="Nhập Tên Khách Hàng" id="tenNhaCungCap" />
                </div>
                <div className="col-md-2">
                  <label>Số Điện Thoại Nhà Cung Cấp</label>
                  <input type="text" className="form-control" placeholder="Nhập Số Điện Thoại Khách Hàng" id="soDienThoaiNhaCungCap" />
                </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <Modal show={showModal} onHide={toggleModal}>
                    ...
                    <Modal.Body>
                      <form>
                        Mã Nhà Cung Cấp: <input type="text" id="maNhaCungCap" className="form-control" /><br />
                        Tên Nhà Cung Cấp: <input type="text" id="tenNhaCungCap" className="form-control" /><br />
                        Số Điện Thoại Khách Hàng: <input type="text" id="soDienThoaiNhaCungCap" className="form-control" /><br />
                  ...
                  <table id="datatable-buttons"
                    ...
                    <thead>
                      <tr>
                        <th><input type="checkbox" id="chonTatCa" onClick={handleCheckAll} /></th>
                    ...
                    <tbody>
                      <tr>
                        <td><input type="checkbox" className="row-check" id="chonDong1" onClick={handleCheck} /></td>
                        <td>KH_001</td>
                        <td>Phan Văn Bình</td>
                        <td>Đà Nẵng</td>
